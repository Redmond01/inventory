    ...
    <div>
      <div className='lg:block md:hidden sm:hidden'>
        ...
        <div className='w-full h-[10svh] flex justify-start items-center'>
           ...
           <Link to={`/Adminlist/${id}`} className='w-[15%]'><h3 className='w-full font-sans font-[600] text-[calc(1.5px_+_1svw_+_1.5svh)] text-center uppercase  text-whites cursor-pointer rounded-full hover:text-red hover:bg-blue bg-red'>go back</h3></Link>
          </div>
